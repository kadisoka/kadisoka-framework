...
func TestApplicationIDNumLimits(t *testing.T) {
	...
	assert.Equal(t, false, ApplicationIDNum(0).IsSound())
	assert.Equal(t, false, ApplicationIDNum(-1).IsSound())
	assert.Equal(t, true, ApplicationIDNum(1).IsSound())
	assert.Equal(t, true, ApplicationIDNum(0xffff).IsSound())
	assert.Equal(t, true, ApplicationIDNum(0xffffff).IsSound())
	assert.Equal(t, true, ApplicationIDNum(0x7fffffff).IsSound())
	assert.Equal(t, false, ApplicationIDNum(1<<28).IsSound())
	assert.Equal(t, true, ApplicationIDNum((1<<30)|0x1).IsFirstParty())
	assert.Equal(t, true, ApplicationIDNum(0x01000000).IsSound())
	assert.Equal(t, true, ApplicationIDNum(0x01000001).IsSound())
	assert.Equal(t, true, ApplicationIDNum(0x01ffffff).IsSound())
}
...
func TestApplicationRefKeyAZIDTextDecodingEmpty(t *testing.T) {
	...
	assert.Equal(t, false, refKey.IsSound())
...
func TestApplicationRefKeyAZIDTextDecodingValid(t *testing.T) {
	...
	assert.Equal(t, true, refKey.IsSound())
