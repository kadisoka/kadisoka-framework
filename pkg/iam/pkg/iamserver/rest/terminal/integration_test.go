...
// 	"github.com/kadisoka/kadisoka-framework/pkg/iam/pkg/iamtestutils"
// )
...
// 		`country_code='1' AND national_number='5550001' AND confirmation_ts IS NULL`).
// 		Scan(&code)
...
// 	var code string
// 	testDB.QueryRow(`SELECT code FROM phone_number_verifications WHERE ` +
// 		`country_code='1' AND national_number='5550002' AND confirmation_ts IS NULL`).
// 		Scan(&code)
